...
const styles = StyleSheet.create({
  ...
  carImagePlaceholder: { aspectRatio: 4 / 3, backgroundColor: COLORS.accentLight, justifyContent: 'center', alignItems: 'center' },
  carImage: { width: '100%', aspectRatio: 4 / 3 },
  carImageWrap: { position: 'relative', aspectRatio: 4 / 3, overflow: 'hidden' },
  carImageScroll: { flex: 1 },
  carImageSlide: { width: '100%', aspectRatio: 4 / 3 },
  dotRow: {
